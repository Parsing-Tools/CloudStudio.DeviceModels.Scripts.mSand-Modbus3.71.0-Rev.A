...
# Parsing + Configuration Script – mSand - Modbus: 3.71.0 - Rev. A

This **Parsing + Configuration** script is designed for the **mSand - Modbus: 3.71.0** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – mSand - Modbus: 3.71.0 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **mSand - Modbus: 3.71.0** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
